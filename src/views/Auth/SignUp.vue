      ...
      <div class="cm-panel-glass w-full rounded-[2rem] border backdrop-blur-[22px]">
        ...
        <form class="grid gap-3 px-6 pt-3 pb-5 sm:px-8 sm:pb-6" @submit.prevent="handleRegister">
          ...
          <UiButton
            type="submit"
            :disabled="loading"
            class="cm-button-primary h-[2.95rem] w-full rounded-2xl text-[0.96rem] font-semibold text-white transition-[transform,box-shadow] duration-150 hover:-translate-y-px active:translate-y-0"
          >
